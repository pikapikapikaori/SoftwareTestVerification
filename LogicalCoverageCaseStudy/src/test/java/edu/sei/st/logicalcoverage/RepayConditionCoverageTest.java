...
class RepayConditionCoverageTest {
    ...
    @Test
    void test5() {
        Repay repay5 = new Repay(true, true, new BigDecimal(10000), false, true, new BigDecimal(0));
        assertEquals("not enough balance ", repay5.doRepay());
    }
}